...
class kaane {
    ...
    public static void main(String[] args) {
        ...
        String modules[]={"","Settings", "Custom Modloader", // KAaNE menus
                ...
                "Benedict Cumberbatch","Big Circle","Binary LEDs","Unfair Cipher","Word Scramble"};
        ...
        b.addActionListener((ActionEvent e) -> {
            ...
            switch (x) {
                ...
                // case "Bitmaps": bitmaps.module(); break; (currently in development, won't be included in 0.7.1)
